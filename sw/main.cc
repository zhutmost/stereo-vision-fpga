...
int main() {
    ...
    XV_demosaic_Initialize(p_demosaic_l, XPAR_DEMOSAIC_L_DEVICE_ID);
    XV_demosaic_Initialize(p_demosaic_r, XPAR_DEMOSAIC_R_DEVICE_ID);
    ...
    status = p_vdma_l.setup(VDMA_DIR_BOTH, 0x01000000, 3, 1280, 720, 2048, 2048);
    status = p_vdma_r.setup(VDMA_DIR_BOTH, 0x04000000, 3, 1280, 720, 2048, 2048);
    status = p_vdma_o.setup(VDMA_DIR_BOTH, 0x07000000, 3, 1280, 720, 2048, 2048);
